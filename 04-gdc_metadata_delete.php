...
delete_data($url_Origin,$url_Target,$url_Referer,$guid,$token);
...
function delete_data($url_Origin,$url_Target,$url_Referer,$guid,$token){
        $cmd="curl '".$url_Target."/entities/".$guid."' \
-X 'DELETE' \
